...
export default function RegisterClient() {
  ...
  // Resend phone OTP — was referenced in the JSX but not previously
  // defined; mirrors handleResendEmail / login's handleResendOtp pattern.
  const handleResendPhone = async () => {
    ...
    try {
      ...
      setPhoneError(err.message || 'Failed to resend code');
    } finally {
      setPhoneLoading(false);
    }
  };
