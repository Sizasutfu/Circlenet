        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="flex-1 relative">
            <input
              ...
              placeholder={user ? 'Write a comment… Use @ to mention someone' : 'Log in to comment'}
              className="w-full bg-[var(--color-surface)] rounded-[var(--radius-radius-sm)] px-3 sm:px-4 py-2 text-sm text-[var(--color-txt)] placeholder:text-[var(--color-txt3)] border border-[var(--color-border)] focus:border-[var(--color-accent)] focus:outline-none"
