...
export default function SideBar() {
  ...
  const handleCreatePost = () => {
    ...
    // You can replace with a modal or navigation to /compose
  };
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-[260px] flex-col bg-[var(--color-card)] border-r border-[var(--color-border)] shadow-[var(--color-shadow)]">
      {/* Logo */}
